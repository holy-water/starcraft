	...
	public final TilePosition getBuildLocationWithSeedPositionAndStrategy(UnitType buildingType,
		...
		// seedPosition 을 입력하지 않은 경우
			...
			case MultipleExpansion:
					...
					if (MyBotModule.Broodwar.mapFileName().contains("Circuit")) {
						if (locationOfBase == 1) {
							if (enemyLocation == 2) {
								...
								orderOfBaseLocations.put(3, numberOfBaseLocations.get(9));
								orderOfBaseLocations.put(4, numberOfBaseLocations.get(10));
								orderOfBaseLocations.put(5, numberOfBaseLocations.get(11));
								orderOfBaseLocations.put(6, numberOfBaseLocations.get(12));
								orderOfBaseLocations.put(7, numberOfBaseLocations.get(13));
								orderOfBaseLocations.put(8, numberOfBaseLocations.get(14));
								...
								orderOfBaseLocations.put(5, numberOfBaseLocations.get(5));
								orderOfBaseLocations.put(6, numberOfBaseLocations.get(8));
								orderOfBaseLocations.put(7, numberOfBaseLocations.get(15));
								orderOfBaseLocations.put(8, numberOfBaseLocations.get(14));
								...
								orderOfBaseLocations.put(7, numberOfBaseLocations.get(9));
								orderOfBaseLocations.put(8, numberOfBaseLocations.get(10));
							...
							if (enemyLocation == 1) {
								...
								orderOfBaseLocations.put(3, numberOfBaseLocations.get(15));
								orderOfBaseLocations.put(4, numberOfBaseLocations.get(13));
								orderOfBaseLocations.put(5, numberOfBaseLocations.get(14));
								orderOfBaseLocations.put(6, numberOfBaseLocations.get(12));
								...
								orderOfBaseLocations.put(1, numberOfBaseLocations.get(4));
								orderOfBaseLocations.put(2, numberOfBaseLocations.get(3));
								orderOfBaseLocations.put(3, numberOfBaseLocations.get(2));
								orderOfBaseLocations.put(4, numberOfBaseLocations.get(0));
							...
							if (enemyLocation == 1) {
								...
								orderOfBaseLocations.put(3, numberOfBaseLocations.get(13));
								orderOfBaseLocations.put(4, numberOfBaseLocations.get(14));
								orderOfBaseLocations.put(5, numberOfBaseLocations.get(15));
								orderOfBaseLocations.put(6, numberOfBaseLocations.get(8));
								orderOfBaseLocations.put(7, numberOfBaseLocations.get(6));
								...
								orderOfBaseLocations.put(7, numberOfBaseLocations.get(4));
								orderOfBaseLocations.put(8, numberOfBaseLocations.get(5));
							...
							if (enemyLocation == 1) {
								...
								orderOfBaseLocations.put(2, numberOfBaseLocations.get(12));
								orderOfBaseLocations.put(3, numberOfBaseLocations.get(11));
								orderOfBaseLocations.put(4, numberOfBaseLocations.get(10));
								...
								orderOfBaseLocations.put(5, numberOfBaseLocations.get(9));
								orderOfBaseLocations.put(6, numberOfBaseLocations.get(7));
								orderOfBaseLocations.put(7, numberOfBaseLocations.get(1));
								orderOfBaseLocations.put(8, numberOfBaseLocations.get(0));
								...
								orderOfBaseLocations.put(1, numberOfBaseLocations.get(13));
								orderOfBaseLocations.put(2, numberOfBaseLocations.get(8));
								orderOfBaseLocations.put(3, numberOfBaseLocations.get(6));
				...
				// orderOfBaseLocations.get(i).getTilePosition().getX() + " "
				// + orderOfBaseLocations.get(i).getTilePosition().getY());
				// }
